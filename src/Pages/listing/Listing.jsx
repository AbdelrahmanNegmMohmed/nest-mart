                    ...
                    <div className="col-md-9 rightContent homeProducts pt-0">
                        <div className="topStrip d-flex align-items-center">
                            ...
                            <div className="ml-auto d-flex align-items-center contenbuttom">
                                ...
                                <Button className='btn_' onClick={()=>setisopendropdown(!isopendropdown)}><GridViewIcon/>show: 50<KeyboardArrowDownIcon/></Button>
                                {
                                    isopendropdown !== false &&  <ul className="dropdownmenu droplisting">
                                ...
                                <Button className='btn_' onClick={()=>setisopendropdown2(!isopendropdown2)}><FilterListIcon/>Sort by: Featured<KeyboardArrowDownIcon/></Button>
                                {
                                    isopendropdown2 !== false &&  <ul className="dropdownmenu droplisting">
                                    <li><Button className='align-items-center'onClick={()=>setisopendropdown2(false)}>Featuredt</Button></li>
